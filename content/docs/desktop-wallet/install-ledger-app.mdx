---
substitutions:
  ccd-governance-version: '**1.3.0**'
  nano-s-firmware: '**2.1.0**'
  nano-s-plus-firmware: '**1.4.0**'
---
...
<Callout
  body={<>
The steps here are only for members of the governance committee. If you are not a member of the governance committee, see [Install the Concordium LEDGER app using LEDGER Live](#install-ledger) for instructions on how to install.
  </>}
  variant="warning"
/>
