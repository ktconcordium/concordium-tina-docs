---
title: "View transaction proposals"
---
...
The list of proposals gives you an overview of all the multi-signature proposals you've created and their status. The proposals are shown in chronological order. By default, you can view the latest 50 transactions, but you have the possibility of viewing more if needed. Not sure how this works yet. Maybe in the coming release?
