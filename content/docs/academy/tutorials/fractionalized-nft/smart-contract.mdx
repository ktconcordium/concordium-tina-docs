---
title: "Fractionalized NFT smart contract"
---

(fractionalized-nft-sc)=
...
You will implement custom errors for this project like the ones below where the last six errors are custom errors. For more information about custom errors in Concordium smart contracts, see [Custom errors](/docs/mainnet/docs/smart-contracts/guides/custom-errors#custom-errors).
