...
![visual studio code window in dark mode after creating project](/images/beg-reg-data1.png)

![web browser tab with application interface](/images/beg-reg-data2.png)
...
![visual studio code window in dark mode with package.json file open](/images/beg-reg-data3.png)console
import {
...
![web browser tab with dApp running](/images/beg-reg-data4.png)

![web browser tab with dApp running](/images/beg-reg-data5.png)

Fill it in with the string `concordium` and click **REGISTER DATA**.

![web browser tab with dApp running and web wallet extension open](/images/beg-reg-data6.png)

![web browser tab with CCDScan running showing transaction lookup](/images/beg-reg-data7.png)

It redirects you to that partciular block in CCDScan.

![web browser tab with dApp running](/images/beg-reg-data8.png)

![web browser tab with sha256 tool running](/images/beg-reg-data9.png)
