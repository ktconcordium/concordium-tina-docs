...
When you have your Concordium account, meaning your ID object is created, there is a set of **attributes** that is inside of your encrypted data structure. A full list of the attributes can be [found here](#create-proofs), but some of them are listed below.
