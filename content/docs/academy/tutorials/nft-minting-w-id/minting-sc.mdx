...
![visual studio code window in dark mode while editing cargo.toml file](/images/adv-sc1.png)console
/// The contract state,
///
...
Nice! You are done with the smart contract. Without slowing down, start the [frontend development](/docs/academy/tutorials/nft-minting-w-id/frontend#nft-w-id-frontend).