...
![visual studio code window in dark mode with terminal window open showing result](/../images/adv-frontend1.png)

![browser tab showing result of running the locally built frontend](/../images/adv-frontend2.png)
...
![visual studio code window in dark mode with package.json file open](/../images/adv-frontend3.png)console
...
![browser tab showing result of running the locally built frontend](/../images/adv-frontend4.png)console
import {
AppBar,
Box,
Container,
...
![browser tab showing result of running the locally built frontend](/../images/adv-frontend5.png)console
...
And now try it in [the next part](/docs/academy/tutorials/nft-minting-w-id/how-it-works#nft-w-id-demo).
