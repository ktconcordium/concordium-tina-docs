---
title: "Contract interactions with Concordium-Rust-SDK"
---

(mid-tutorial-contract-interactions)=
...
![](/images/mid-nft-scactions3.png)console
Action::WithSchema {
            parameter,
            schema,
            address,
...
Now you can call the `mint()` function from your new instance. For the complete minting tutorial you can follow [the NFT minting tutorial from Concordium's developer portal](/docs/mainnet/tutorials/nft-minting/index#nft-index). Create a file called **nft-params.json** (similar to the tutorial) in the **nft-params** folder to mint your token and add your address and token ID to the file. And copy the schema file from the **concordium-out** folder to the **nft-params** folder.
...
![](/images/mid-nft-scactions4.png){image} ../../images/mid-nft-scactions5.png
```
...
![](/images/mid-nft-scactions6.png)json
[
    "TOKEN-ID",
    "TOKEN-ID"
]
...
![](/images/mid-nft-scactions7.png)console
...
Congrats! You have successfully completed the Concordium NFT Minting Tutorial with Rust-SDK! The full code can be found [here](https://github.com/bogacyigitbasi/nft-rust-sdk).