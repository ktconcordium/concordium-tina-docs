...
![visual studio code window in dark mode after creating project](/images/beg-minting-dapp1.png)

![web browser tab with application interface](/images/beg-minting-dapp2.png)
...
![visual studio code window in dark mode with package.json file open](/images/beg-minting-dapp3.png)console
import {
...
Call the **Header.tsx** component from the **App.tsx** instead of its default values. If you don't already have the Concordium Wallet for Web installed you can [download and set it up](/docs/mainnet/docs/browser-wallet/setup-browser-wallet#setup-browser-wallet). You are almost ready to test your **Connect** button!

![web browser tab with application interface waiting to connect](/images/beg-minting-dapp4.png)

![web browser tab with application interface with web wallet extension pop up to](/images/beg-minting-dapp5.png)

See how easy it is to connect an application with Concordium!

Now, add more to your dApp. Minting functionality! Remember that in order to call a contract you should have the contract implemented in Rust and deployed on the chain using `concordium-client`. For information about how to do this, see the [tutorials](/docs/mainnet/tutorials/index#sc-tutorials). When you deploy a contract, Concordium gives you a module reference which is a unique hash value. You need that because you are going to invoke that contract from your brand new dApp!
...
![web browser tab with application interface waiting to initialize contract](/images/beg-minting-dapp6.png)console
import { detectConcordiumProvider } from "@concordium/browser-wallet-api-helpers";
import {
AccountTransactionType,
CcdAmount,
...
![web browser tab with application interface waiting to mint nft](/images/beg-minting-dapp7.png)

Now try it! First, initialize your contract, and fill out the form with the necessary inputs. If you need some help with Metadata you can check [this tutorial](/docs/mainnet/tutorials/nft-minting/upload-nft#upload-nft).