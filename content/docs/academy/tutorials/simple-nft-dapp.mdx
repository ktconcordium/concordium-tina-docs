...
Call the **Header.tsx** component from the **App.tsx** instead of its default values. If you don't already have the Concordium Wallet for Web installed you can [download and set it up](#setup-browser-wallet). You are almost ready to test your **Connect** button!
...
Now try it! First, initialize your contract, and fill out the form with the necessary inputs. If you need some help with Metadata you can check [this tutorial](#upload-nft).
