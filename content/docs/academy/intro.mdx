...
You can read more about Identities, Accounts, Staking, and other concepts of Concordium [in the documentation](https://developer.concordium.software/en/mainnet/net/guides/learn-about-concordium.html).
