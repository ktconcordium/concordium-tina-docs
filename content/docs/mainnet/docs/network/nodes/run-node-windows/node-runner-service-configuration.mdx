---
title: "Concordium Windows node runner service configuration"
---
...
[endpoint configuration](https://github.com/Concordium/concordium-node/blob/main/docs/grpc2.md), since
