---
title: "Advanced node configuration on Docker"
---
...
When mounting host directories on distributions running [SELinux](https://en.wikipedia.org/wiki/Security-Enhanced_Linux) special considerations apply.
In particular, this includes Fedora and its derivatives. See [the Docker documentation](https://docs.docker.com/storage/bind-mounts/#configure-the-selinux-label) for details on how to proceed.
