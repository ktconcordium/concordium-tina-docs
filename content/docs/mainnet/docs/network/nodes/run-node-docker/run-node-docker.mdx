---
title: "Install and manage a node on Docker"
---

(run-a-node)=


This article explains how to run a Concordium node in Docker on Linux on mainnet or testnet, and how to set up your node as a [validator node](/docs/mainnet/docs/network/nodes/run-node-docker/run-node-docker#configure-baker-docker).
...
Concordium provides two Docker images, a [mainnet](https://hub.docker.com/r/concordium/mainnet-node) one and a [testnet](https://hub.docker.com/r/concordium/testnet-node) one.
...
.. Note::
   ...
   [hub.docker.com/concordium/mainnet-node](https://hub.docker.com/r/concordium/mainnet-node) and change the
   ``image`` value from
...
- the image used is the testnet image. See [hub.docker.com/concordium/testnet-node](https://hub.docker.com/r/concordium/testnet-node) for a list of currently available versions.
...
.. Note::
   ...
   good practice to choose the version deliberately. To choose a specific
   version, find the correct version in
   [hub.docker.com/concordium/testnet-node](https://hub.docker.com/r/concordium/testnet-node) and change the
   ``image`` value from
...
(configure-baker-docker)=

## Run a validator node

For information about how to run a validator node for Linux/Docker, see [Import validator keys](/docs/mainnet/docs/network/guides/import-validator-keys#import-validator-keys).
