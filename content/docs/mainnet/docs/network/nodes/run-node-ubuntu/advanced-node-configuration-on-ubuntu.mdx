---
title: "Advanced node configuration on Ubuntu"
---
...
[if so configured](/docs/mainnet/docs/network/guides/import-validator-keys#import-validator-keys), to produce blocks.
