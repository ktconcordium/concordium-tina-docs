---
title: "Stop a validator"
---

(stop-validator)=


If you remove a validator, the node that is configured with the validator keys will stop producing blocks after the next [pay day](/docs/mainnet/docs/resources/glossary#pay-day).

After the [cool-down period](/docs/mainnet/docs/resources/glossary#cool-down-period), the amount that you previously staked is returned to your disposable balance at the next pay day.
...
2. On the validation screen, tap **Stop**.

3. You will see a message explaining about the implications of stopping validation. Tap **Continue** to procced.

4. On the overview screen, review the information. Swipe right on the **Stop validation** slider to submit the validation update.

5. The wallet shows a confirmation screen with a green checkmark indicating that your validation update has been successfully submitted to the chain. You can click **Transaction details** to view more information about the transaction, or **Close** to return to the main screen.
  </>}
  image=""
  fullWidth={true}
/>
...
![screen showing validator update options](/images/browser-wallet/new/update_validation1.png)
...
![screen showing send stop validator transaction](/images/browser-wallet/new/stop_validator_send.png)
...
![success screen for stopping validator](/images/browser-wallet/new/stop_validator2.png)
  </>}
  image=""
  fullWidth={true}
/>
...
![screen showing that validator will be removed](/images/desktop-wallet/dw-remove-baker.png)
