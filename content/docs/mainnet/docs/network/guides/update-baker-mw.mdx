...
1. Go to **Accounts** and select the account whose validator stake you want to change. Click **More options**.

2. Click **Validation**.

3. Click **Update validator stake**.
  </>}
  image=""
  fullWidth={true}
/>
...
1. Go to **Accounts** and select the account on which you have a staking pool that you want to update and click **More options**.

2. Select **Validation**.

3. Click **Update staking pool**.
  </>}
  image=""
  fullWidth={true}
/>
