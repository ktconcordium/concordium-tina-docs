...
<accordion
  ...
  docText={<>
1. After [reinstalling](/docs/mainnet/docs/browser-wallet/setup-browser-wallet#setup-bw) the Concordium Wallet for Web, open the extension and click **Get started** on the welcome page.
...
<Callout
  body={<>
You cannot recover a wallet created in Mainnet in Testnet, and vice versa. Once you have recovered on the correct network, you can [switch between Mainnet and Testnet](/docs/mainnet/docs/browser-wallet/setup-browser-wallet#switch-network).
...
<Callout
  body={<>
  If you forget your passcode for your installed Concordium Wallet for Web, you will need to [remove the extension in your internet browser and reinstall it](/docs/mainnet/docs/browser-wallet/setup-browser-wallet#setup-browser-wallet), choosing the option to recover your wallet. Use your seed phrase to recover the wallet.
</>}
image=""
fullWidth={true}
  </>}
