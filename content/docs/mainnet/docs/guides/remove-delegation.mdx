---
title: "Remove delegation to a staking pool or passive delegation"
---
...
If you remove the delegation, there is a [cool-down period](/docs/mainnet/docs/resources/glossary#cool-down-period) before the amount you had delegated is returned to your disposable balance.
...
2. On the earning status screen, tap **Stop**.

3. You will see a screen explaining the implications of stopping your delegation, tap **Continue** to proceed.

4. On the overview screen, review the information. Swipe right on the **Stop staking** slider to submit the delegation stop.

5. The wallet shows a confirmation screen with a green checkmark indicating that your delegation update has been successfully submitted to the chain. You can click **Transaction details** to view more information about the transaction, or **Close** to return to the main screen.
  </>}
  image=""
  fullWidth={true}
/>
...
2. Select **Delegation** and choose **Remove Delegation**.
  ...
  fullWidth={true}
/>
![delegation screen with options to update or remove](/../images/desktop-wallet/dw-delegation-menu.png)
   #. Review the cool-down period. Click **Continue**.

![remove delegation confirmation screen](/../images/desktop-wallet/dw-remove-delegation.png)
...
![](/../images/browser-wallet/new/stop_delegation1.png)
3. Review the information. Note that your delegated stake will be released after 7 days. Click **Send** to finalize the transaction.

![](/../images/browser-wallet/new/stop_delegation_send.png)
4. The wallet shows a confirmation screen with a green checkmark indicating that your delegation has been successfully stopped. You can click **Transaction details** to view more information about the transaction, or **Return to account** to return to your account overview.

![](/../images/browser-wallet/new/stop_delegation3.png)
  </>}
  image=""
  fullWidth={true}
/>