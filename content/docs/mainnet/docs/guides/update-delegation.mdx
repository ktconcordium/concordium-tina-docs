---
title: "Update delegation to a staking pool or passive delegation"
---
...
If you change the delegation, the new amount will be applied at the start of the next [pay day](/docs/mainnet/docs/resources/glossary#pay-day). There is one pay day approximately every 24 hours.
Note that if you decrease or remove the delegation, there is a [cool-down period](/docs/mainnet/docs/resources/glossary#cool-down-period) before the amount you’ve decreased the delegation by is returned to your disposable balance.

Before delegating stake to a staking pool, it is important to research the pool using [CCDScan](/docs/mainnet/tools/ccd-scan/ccd-scan#ccd-scan). You can only have one delegation per account.
...
![](/../images/browser-wallet/new/validator_suspended_banner.png)
...
2. On the earning status screen, tap **Update**.

3. This will open an informational screen explaining the update options for delegation. Tap **Update delegation** to proceed.
...
![screen with options to choose delegation type](/../images/cryptoX/cryptox-update-delegation1.png)
5. On the overview screen, review the information. Swipe right on the **Update delegation** slider to submit the delegation update.

6. The wallet shows a confirmation screen with a green checkmark indicating that your delegation update has been successfully submitted to the chain. You can click **Transaction details** to view more information about the transaction, or **Close** to return to the main screen.
  </>}
  image=""
  fullWidth={true}
/>
...
1. Go to **Accounts** and select the account on which you want to change your delegation preferences then click **More options**.

2. Click **Delegation** and choose **Update Delegation**.
  </>}
  image=""
  fullWidth={true}
/>
![screen with options expanded](/../images/desktop-wallet/dw-delegation-menu.png)
...
![screen to choose delegation type and target](/../images/desktop-wallet/dw-update-delegation-target.png)
...
![screen to set amount and redelegation options](/../images/desktop-wallet/dw-update-delegation-stake.png)
...
<accordion
  ...
  docText={<>
1. In the dropdown list, select the delegating account and click **Earn**.

2. Click **Update**.

![](/../images/browser-wallet/new/update_delegation1.png)
3. On the next screen, you can modify delegation preferences. Select *Validator* to delegate to a specific validator pool of your choice, select *Passive* to use passive delegation. Click **Continue** to proceed.

![](/../images/browser-wallet/new/update_delegation2.png)
4. On the next screen, you can make any desired changes to your delegation amount and change your restake rewards options. Click **Continue** to proceed.

![](/../images/browser-wallet/new/update_delegation3.png)
5. Review the information including your delegation amount, and commission rates. When you're satisfied with the configuration, click **Send** to finalize the transaction.

![](/../images/browser-wallet/new/update_delegation_send.png)
6. The wallet shows a confirmation screen with a green checkmark indicating that your delegation settings have been successfully updated. You can click **Transaction details** to view more information about the transaction, or **Return to account** to return to your account overview.

![](/../images/browser-wallet/new/update_delegation5.png)
  </>}
  image=""
  fullWidth={true}
/>