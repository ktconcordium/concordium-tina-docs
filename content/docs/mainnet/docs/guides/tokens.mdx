...
1. Tap the field for what to send.
  </>}
  image=""
  fullWidth={true}
/>
...
1. Click **Manage token list** at the bottom of the screen.

2. Click the **+** at the Manage token list screen.
  </>}
  image=""
  fullWidth={true}
/>
...
1. Click **Send** and select the token type in the dropdown list, or click on the token type and then, click **Send**.

2. Enter the amount you want to send. The number of decimal places depends on the token and is specified for each token when clicking on it.

3. Add the receiver address.
