...
JSON Object containing the chain meta data, see [context-metadata](/docs/mainnet/docs/smart-contracts/references/simulate-context#context-metadata) for a
...
JSON array of the policies of the sender, see [context-sender-policy](/docs/mainnet/docs/smart-contracts/references/simulate-context#context-sender-policy) for a
reference a policy.
...
format of [RFC3339] with precision up to milliseconds.

(context-sender-policy)=
