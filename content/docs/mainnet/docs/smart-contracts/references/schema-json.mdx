---
title: "Schema JSON representation"
---
...
:::{seealso}
See [contract-schema](/docs/mainnet/docs/smart-contracts/contract-schema#contract-schema) for more information on this topic.
:::
...
Supplied as a JSON string using the [RFC3339] format with the precision of
...
See [enum](/docs/mainnet/docs/smart-contracts/references/schema-json#enum) for an example.
