...
- [An example contract](https://github.com/Concordium/concordium-rust-smart-contracts/blob/main/examples/signature-verifier/src/lib.rs)
- [concordium-std documentation](https://docs.rs/concordium-std/latest/concordium_std/type.CryptoPrimitives.html)
- [Host function reference](/docs/mainnet/docs/smart-contracts/references/host-fns#host_function_crypto_primitives)
