...
A [smart contract instance](/docs/mainnet/docs/resources/glossary#instance) is a smart contract module together with a
...
For example, for an [auction](/docs/mainnet/docs/smart-contracts/introduction#auction) contract, there could be multiple instances, each
...
module](/docs/mainnet/docs/smart-contracts/contract-module#contract-module) via the `init` transaction which invokes the
...
(contract-instances-init-on-chain)=
...
:::{seealso}
See the [initialize-contract](/docs/mainnet/docs/smart-contracts/guides/initialize-contract#initialize-contract) guide for how to initialize a
...
as a [prefix tree](https://en.wikipedia.org/wiki/Trie), where nodes in the
...
:::{seealso}
See [host-functions-state](/docs/mainnet/docs/smart-contracts/references/host-fns#host-functions-state) for a reference of these functions.
:::
...
(contract-instances-logging-events)=
...
:::{seealso}
See [host-functions-log](/docs/mainnet/docs/smart-contracts/references/host-fns#host-functions-log) for the reference of this function.
:::
...
(contract-instance-upgradeability)=
...
:::{seealso}
See [guide-upgradable-contract](/docs/mainnet/docs/smart-contracts/guides/upgradeable-contract#guide-upgradable-contract) for a guide about how to make a Rust smart contract
upgradeable.
:::
