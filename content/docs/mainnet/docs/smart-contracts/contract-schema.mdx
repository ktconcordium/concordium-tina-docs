...
Rust, see [build-schema](/docs/mainnet/docs/smart-contracts/guides/build-schema#build-schema).
:::
...
[serialize JSON parameters](/docs/mainnet/docs/smart-contracts/guides/initialize-contract#init-passing-parameter-json)
...
For a reference on how a schema type is serialized into bytes, refer to the [implementation in Rust].

(contract-schema-which-to-choose)=

## Embed schemas on-chain

Schemas are embedded into smart contract modules using the [custom
section][custom section] feature of Wasm modules.
...
[implementation in rust]: https://github.com/Concordium/concordium-base/blob/main/smart-contracts/contracts-common/concordium-contracts-common/src/schema.rs