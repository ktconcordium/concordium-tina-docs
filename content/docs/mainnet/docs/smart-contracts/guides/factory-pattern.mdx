...
![sequence diagram showing the idealized interaction for the factory pattern](./images/ideal-factory.svg)

![sequence diagram showing how the factory pattern might be realised on Concordium](/images/concordium-factory.svg)
...
The guide below is based on the [factory contract example](https://github.com/Concordium/concordium-rust-smart-contracts/blob/main/examples/factory/src/lib.rs),
...
![sequence diagram showing how a third party might hijack a product](/images/factory-adversary.svg)Rust
...
![sequence diagram showing how a hijacking attempt fails](/images/factory-adversary2.svg)

![sequence diagram showing how a hijacking attempt may succeed if the user is deceived](/images/factory-tricked.svg)
