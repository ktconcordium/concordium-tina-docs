---
title: "Deploy a smart contract module"
---
...
Make sure that you are [running a node](/docs/mainnet/docs/network/nodes/node-requirements#node-requirements) using the latest [Concordium software](/docs/mainnet/docs/installation/downloads#downloads) and
that you have a [smart-contract module](/docs/mainnet/docs/smart-contracts/guides/build-contract#build-contract) ready to be deployed.
...
[initialize-contract](/docs/mainnet/docs/smart-contracts/guides/initialize-contract#initialize-contract).

For more information about module references, see [references-on-chain](/docs/mainnet/docs/smart-contracts/references/references-on-chain#references-on-chain).
:::
