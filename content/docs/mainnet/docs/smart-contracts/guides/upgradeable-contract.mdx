---
title: "Upgradeability Guide"
---

(guide-upgradable-contract)=
...
:::{seealso}
To learn more about upgradeability of smart contracts see [contract-instance-upgradeability](/docs/mainnet/docs/smart-contracts/contract-instances#contract-instance-upgradeability).
:::
...
by the default (*high_level*) `upgrade` function, it would overwrite the state stored by the `migration` function. The [upgrade tutorial](/docs/mainnet/tutorials/smartContractUpgrade/index#intro-smart-contract-upgrade)
...
:::{seealso}
For a tutorial on how to execute a smart contract upgrade see [upgrade tutorial](/docs/mainnet/tutorials/smartContractUpgrade/index#intro-smart-contract-upgrade).
:::

:::{seealso}
For a guide on how to send interact with a smart contract using JSON see [interact-instance-json-parameters](/docs/mainnet/docs/smart-contracts/guides/interact-instance#interact-instance-json-parameters).
:::