...
[build-contract](/docs/mainnet/docs/smart-contracts/guides/build-contract#build-contract).
:::

## Compiling to Wasm

To help building smart contract modules and to take advantage of features
such as [contract schemas](/docs/mainnet/docs/smart-contracts/contract-schema#contract-schema), Concordium recommends using the
`cargo-concordium` tool for building [Rust] smart contracts.
...
available docker images can be found on [DockerHub.](https://hub.docker.com/r/concordium/verifiable-sc)
...
Verifiable builds require a container runtime such as [Docker](https://www.docker.com/) to be installed.

Additional information about verifiable builds can be found on [Github](https://github.com/Concordium/concordium-smart-contract-tools/blob/main/cargo-concordium/README.md#reproducible-and-verifiable-builds).
...
If you want a smaller code footprint, enable the [wee_alloc feature](/docs/mainnet/docs/smart-contracts/guides/setup-contract#setup-wee-alloc-feature) by using:
...
preparation is required](/docs/mainnet/docs/smart-contracts/guides/build-schema#build-schema).
...
The file `my_module.wasm.v1` will be used when [deploying](/docs/mainnet/docs/smart-contracts/guides/deploy-module#deploy-module) a smart contract on-chain.
  </>}
  variant="info"
/>
