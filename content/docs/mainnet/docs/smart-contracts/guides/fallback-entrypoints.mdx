...
[setup-env](/docs/shared/setup-env#setup-env).
:::
...
An example proxy contract can be seen [here](https://github.com/Concordium/concordium-rust-smart-contracts/blob/main/examples/proxy/src/lib.rs).
:::