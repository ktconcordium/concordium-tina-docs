...
- [Get token list](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-get-token-list)
- [Get token information](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-get-token-info)
- [Get account information](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-get-account-info)

**Token holder operations:**

- [Transfer tokens](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-transfer-tokens)
- [Mint tokens](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-mint-tokens)
- [Burn tokens](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-burn-tokens)

**Token governance operations:**

- [Add account to allow list](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-add-account-to-allow-list)
- [Remove account from allow list](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-remove-account-from-allow-list)
- [Add account to deny list](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-add-account-to-deny-list)
- [Remove account from deny list](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-remove-account-from-deny-list)
- [Pause a token](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-pause-plt-transfers)
- [Unpause a token](/docs/mainnet/docs/plt/examples/web-sdk#web-sdk-unpause-plt-transfers)

(querying-tokens)=

## Querying tokens

(web-sdk-get-token-list)=
...
(web-sdk-token-holder-operations)=

## Token holder operations

(web-sdk-transfer-tokens)=
...
(web-sdk-token-governance-operations)=
...
(web-sdk-list-management)=

## Allow and deny list management

(web-sdk-add-account-to-allow-list)=
...
(web-sdk-remove-account-from-allow-list)=
...
(web-sdk-add-account-to-deny-list)=
...
(web-sdk-remove-account-from-deny-list)=
