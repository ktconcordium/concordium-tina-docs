---
title: "Concordium Client CLI Tool"
---

(plt-concordium-client)=
...
Download and install `concordium-client`: [Downloads](/docs/mainnet/docs/installation/downloads#concordium-node-and-client-download)
...
(concordium-client-get-token-list)=
...
(concordium-client-transfer-tokens)=
