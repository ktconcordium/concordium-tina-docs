...
- [Get token list](/docs/mainnet/docs/plt/examples/rust-sdk#rust-get-token-list)
- [Get token information](/docs/mainnet/docs/plt/examples/rust-sdk#rust-get-token-info)
- [Get account information](/docs/mainnet/docs/plt/examples/rust-sdk#rust-get-account-info)

**Token holder operations:**

- [Transfer tokens](/docs/mainnet/docs/plt/examples/rust-sdk#rust-transfer-tokens)
- [Mint tokens](/docs/mainnet/docs/plt/examples/rust-sdk#rust-mint-tokens)
- [Burn tokens](/docs/mainnet/docs/plt/examples/rust-sdk#rust-burn-tokens)

**Token governance operations:**

- [Add account to allow list](/docs/mainnet/docs/plt/examples/rust-sdk#rust-add-to-allow-list)
- [Remove account from allow list](/docs/mainnet/docs/plt/examples/rust-sdk#rust-remove-from-allow-list)
- [Add account to deny list](/docs/mainnet/docs/plt/examples/rust-sdk#rust-add-to-deny-list)
- [Remove account from deny list](/docs/mainnet/docs/plt/examples/rust-sdk#rust-remove-from-deny-list)
- [Pause a token](/docs/mainnet/docs/plt/examples/rust-sdk#rust-pause-token)
- [Unpause a token](/docs/mainnet/docs/plt/examples/rust-sdk#rust-unpause-token)
