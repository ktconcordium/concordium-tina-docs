---
title: "Onboarding for Solana developers"
---

(solana-overview)=


This overview outlines the main differences of account models and smart contract functionality between Solana and Concordium. [The FAQ](/docs/mainnet/docs/help-and-faq/onboarding-guide-solana-developers/faq#solana-faq) answers commonly asked questions.
...
Note that CCD cannot be transferred to the smart contract balance without calling a specific entrypoint or a [fallback entrypoint](/docs/mainnet/docs/smart-contracts/guides/fallback-entrypoints#fallback-entrypoints).
...
The example code is taken from [example-helloworld](https://github.com/solana-labs/example-helloworld) and adjusted.
