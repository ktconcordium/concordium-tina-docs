---
title: "Concordium documentation style guide"
---
...
1. **Documentation types** - An overview of the different types of documentation following the [Divio system](https://docs.divio.com/documentation-system/).
2. **Tone of voice and language** - Principles for clear and consistent communication, defining our documentation's voice and language style.
3. **Formatting** - The technical aspects of documentation formatting, including how to structure documents, format code examples, and present visual elements.
4. **Review checklist** - A verification list to help maintain documentation quality and reduce the risk of common issues.

Find information on how to set up the documentation environment [here](https://docs.concordium.com/en/mainnet/docs/help-and-faq/set-up-doc-env.html).

## Documentation Types

Our documentation follows the [Divio system](https://docs.divio.com/documentation-system/), organizing content into four distinct types:
...
Unless it is necessary to show the address, use the inline method for hyperlinks, e.g. `` ` [Concordium](https://www.concordium.com) ` ``.
...
- Then using the variable bw, for example `Concordium Wallet for Web`, in the text.
...
```
<accordion
  heading="The text the reader sees on the clickable dropdown"
  docText={<>
...
In the topic where the term is referenced, use the `` [my term](/docs/mainnet/docs/resources/glossary#my-term) `` directive when writing a glossary term in the text. If you want to use different text than how the term appears in the glossary, use the following format: `` [my text](/docs/mainnet/docs/resources/glossary#my-term) ``.
