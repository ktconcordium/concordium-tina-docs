---
title: "Update the Desktop Wallet"
---
...
To manually update the desktop wallet, go to the [downloads page](/docs/mainnet/docs/installation/downloads#downloads-desktop-wallet) and download the latest version.
