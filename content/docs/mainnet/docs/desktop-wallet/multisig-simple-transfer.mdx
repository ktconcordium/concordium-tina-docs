...
- Set up an [identity and an account](/docs/mainnet/docs/guides/create-identity#create-initial-account).
- Set up an [account with multiple credentials](/docs/mainnet/docs/guides/multi-credentials#multi-credentials)
- Set up a [LEDGER NANO device identity](/docs/mainnet/docs/guides/overview-desktop#install-ledger).
...
- [Generate the transaction proposal without signing](/docs/mainnet/docs/desktop-wallet/multisig-simple-transfer#generate-transfer-without-sign). This option enables you to export the transaction proposal without signing it. You don't need a LEDGER device, but you do need an internet connection.
- [Generate and sign the transaction](/docs/mainnet/docs/desktop-wallet/multisig-simple-transfer#generate-sign-transfer). This option requires a LEDGER device and an internet connection.
