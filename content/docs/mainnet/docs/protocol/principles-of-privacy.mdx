...
(reference-principles-of-privacy)=
...
With Concordium users can choose to reveal [zero-knowledge proof](/docs/mainnet/docs/resources/glossary#zero-knowledge-proof) verifications of attributes of their identity across both [Concordium ID](/docs/mainnet/docs/protocol/identity#concordium-id) and [Web3 ID](/docs/mainnet/docs/protocol/identity#web3-id), without revealing the underlying data (e.g. proving they are over 18 without revealing their birth date).