---
title: Validator suspension
last_edited: '2025-12-03T13:58:50.665Z'
...
* Producing a block
* Having their signature included in a [Quorum Certificate](/docs/mainnet/docs/resources/glossary#quorum-certificate)
