...
This is the second part of [the voting smart contract tutorial](/docs/mainnet/tutorials/voting/voting-sc#voting-sc). In this part of the tutorial,
...
the frontend, users will also need to download the Concordium Wallet for Web (or simply "the browser wallet") as a browser extension.
...
To continue the tutorial, we'll need to install the Concordium Wallet for Web. Install the extension for your browser as described [here](/docs/mainnet/docs/browser-wallet/setup-browser-wallet#setup-browser-wallet).

The wallet connects to a server hosted by Concordium which will take care of the Concordium node on your behalf.

For testing you'll need some CCD in your account. Send some CCD to your new account or request some CCD from the [testnet faucet button](/docs/shared/setup-env#testnet-faucet) within the wallet.
...
![](../wCCD/images/wCCD_tutorial_14.png)console
...
[voting dApp](https://voting.testnet.concordium.com/) hosted on testnet. You can use your Concordium Wallet for Web
