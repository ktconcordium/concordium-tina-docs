---
title: "Upgrading smart contracts on Concordium"
---

(intro-smart-contract-upgrade)=

![A smart contract upgrade mechanism](smartContractUpgrade.png)
...
<Callout
  body={<>
If you are unfamiliar with the native upgradability mechanism on Concordium, you can read the [upgrade guide](/docs/mainnet/docs/smart-contracts/guides/upgradeable-contract#guide-upgradable-contract).
  </>}
  variant="info"
/>
