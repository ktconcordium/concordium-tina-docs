---
title: "Upload the NFT"
---

(upload-nft)=


In this part of the tutorial, we will upload your asset and give it metadata. For this, we will use the [InterPlanetary File System (IPFS)](https://docs.ipfs.tech/concepts/what-is-ipfs/).
...
The Concordium CIS-2 standard allows the creation of your NFT metadata in the following format, and you can find more details in the [Concordium CIS-2 token standard](https://proposals.concordium.software/CIS/cis-2.html#example-token-metadata-non-fungible). For the sake of the minting process, you have to follow the same formatted .json file, but as you can see, you are also allowed to add additional attributes to the metadata file, or remove them.
...
Continue to the [next part](/docs/mainnet/tutorials/nft-minting/build-smart-contract#build-smart-contract) of the tutorial to build your smart contract and initialize it.
