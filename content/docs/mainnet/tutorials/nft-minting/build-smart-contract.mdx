---
title: "Initialize, build, and deploy the smart contract"
---
...
![](/../images/init-error.png){image} images/init-success.png
:width: 100%
```
...
To deploy your smart contract you will use the `concordium client` command line tool. You can read more about this tool in [this article](/docs/mainnet/tools/concordium-client#concordium-client).
...
![](/../images/deploy-success.png){image} images/deploy-success-ccdscan.png
:width: 100%
```
...
![](/../images/initialize-success.png){image} images/contract-index-ccdscan.png
:width: 100%
```
...
Continue to the [final part](/docs/mainnet/tutorials/nft-minting/mint-xfer#mint-transfer) of the tutorial to mint and transfer your NFT.
