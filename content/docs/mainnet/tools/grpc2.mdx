...
The [in-depth documentation](http://developer.concordium.software/concordium-grpc-api/#v2%2fconcordium%2fservice.proto) of the new interface lists and documents all the endpoints.
...
- [.NET SDK](https://github.com/Concordium/concordium-net-sdk)
- [Rosetta](https://github.com/Concordium/concordium-rosetta)
