...
The [concordium-client](/docs/mainnet/tools/concordium-client#concordium-client) tool supports queries of multiple kinds of state against
a backend node:
...
can also decrypt the shielded balance ([deprecated](/docs/mainnet/docs/guides/shield-ccd-wallets#shielded-balance-feature-deprecation)).
...
- `--shielded`: Show the shielded balance ([deprecated](/docs/mainnet/docs/guides/shield-ccd-wallets#shielded-balance-feature-deprecation)).
- `--reveal-shielded`: Show the shielded balance and reveal it
  ([deprecated](/docs/mainnet/docs/guides/shield-ccd-wallets#shielded-balance-feature-deprecation)).
...
- has [transaction sequence number](/docs/mainnet/docs/resources/glossary#transaction-sequence-number) `1`,
- has `a820662531d...` as the key for receiving shielded transfers ([deprecated](/docs/mainnet/docs/guides/shield-ccd-wallets#shielded-balance-feature-deprecation)).
- has no incoming shielded amount ([deprecated](/docs/mainnet/docs/guides/shield-ccd-wallets#shielded-balance-feature-deprecation)).
- has a self balance of `a9d35bf62442aabad72c...` ([deprecated](/docs/mainnet/docs/guides/shield-ccd-wallets#shielded-balance-feature-deprecation)). By default this
  only shows the first 20 characters of the encrypted amount. With a
  `--verbose` flag the full encryption is shown.

Furthermore, the account's credential reveals no attributes from the [identity](/docs/mainnet/docs/resources/glossary#identity)
...
Display the lifecycle state of a [transaction](/docs/mainnet/docs/resources/glossary#transaction) (pending, committed, finalized,
or absent).
...
See the [glossary](/docs/mainnet/docs/resources/glossary#glossary) for detailed descriptions of the individual fields.
...
Show [election parameters](/docs/mainnet/docs/resources/glossary#leader-election) for a specific block, optionally including
bakers and their [lottery power](/docs/mainnet/docs/resources/glossary#lottery-power):
...
Display the list of identity providers or [Privacy Guardians](/docs/mainnet/docs/resources/glossary#privacy-guardian-pg) at a given block,
