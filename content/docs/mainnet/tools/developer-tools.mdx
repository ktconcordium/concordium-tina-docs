...
Some Concordium tools may produce encrypted output. These files can be decrypted and inspected using the **utils** tool. You can download the tool from [Installation downloads](/docs/mainnet/docs/installation/downloads#downloads).
