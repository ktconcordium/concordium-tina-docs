...
To initiate an Office Hours session, simply fill out the form [Request a Concordium Developer Office Hours Session](https://docs.google.com/forms/d/e/1FAIpQLSfyzAVs2mtM1isF4xK6VWTm5WhuKjzyGUW3k2MWZdpVsD9o9A/viewform?usp=dialog). We will review your submission, and once at least 3 requests for the same topic have been received, we will make an announcement about the upcoming session in the [announcements Discord channel](https://discord.com/channels/667378330923696158/1062725290704515092) in the Dev Army category.
